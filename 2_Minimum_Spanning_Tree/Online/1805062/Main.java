...
public class Main {
    ...
    static class Graph {
        ...
        public void primsAlgorithmImplementationPrint(MinimumSpanningTreeResultSet[] MinimumSpanningTreeResultSet){
            double product_min_weight =1 ;
            for (int i = 1; i <vertices ; i++) {
                product_min_weight *= MinimumSpanningTreeResultSet[i].weight;}
            System.out.println("Product of the minimum spanning tree : " +  product_min_weight);
